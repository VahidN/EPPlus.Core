...
namespace OfficeOpenXml.Packaging
{
    ...
    {
        internal protected Dictionary<string, ZipPackageRelationship> _rels = new Dictionary<string, ZipPackageRelationship>(StringComparerEx.InvariantCultureIgnoreCase);
