 ...
 * Author							Change						Date
 * ******************************************************************************
 * Jan Kنllman		    Initial Release		        2011-11-02
 * Jan Kنllman          Total rewrite               2010-03-01
 * Jan Kنllman		    License changed GPL-->LGPL  2011-12-27
 *******************************************************************************/
using System;
    ...
    public class ExcelWorksheet : XmlHelper, IEqualityComparer<ExcelWorksheet>, IDisposable
    {
        internal class Formulas
        {
            ...
            public Formulas Clone()
            {
                ...
                formulas.Address = (string)this.Address;
                formulas.IsArray = this.IsArray;
                formulas.Formula = (string)this.Formula;
