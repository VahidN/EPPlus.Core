...
namespace EPPlus.Core.Tests.SampleApp
{
    ...
    public class Sample15
    {
        ...
        public void VBASample1()
        {
            ...
            //And Save as xlsm
            pck.SaveAs(new FileInfo(Path.Combine("bin", "sample15-1.xlsm")));
        }

        [TestMethod]
        public void VBASample2()
        {
            //Open Sample 1 again
            ExcelPackage pck = new ExcelPackage(new FileInfo(Path.Combine("bin", "sample1.xlsx")));
            //Create a vba project
            pck.Workbook.CreateVBAProject();
            ...
            */
            ...
            //And Save as xlsm
            pck.SaveAs(new FileInfo(Path.Combine("bin", "sample15-2.xlsm")));
        }

        [TestMethod]
        public void VBASample3()
        {
            ...
            pck.SaveAs(new FileInfo(Path.Combine("bin", "sample15-3.xlsm")));
        }
