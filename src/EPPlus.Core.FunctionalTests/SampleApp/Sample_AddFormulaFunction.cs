...
namespace EPPlus.Core.Tests.SampleApp
{
    ...
    /// </summary>
    [TestClass]
    public class Sample_AddFormulaFunction
    {
        [TestMethod]
        public void RunSample_AddFormulaFunction()
        {
            using (var package = new ExcelPackage())
            {
                ...
                package.SaveAs(new FileInfo(Path.Combine("bin", "RunSample_AddFormulaFunction.xlsx")));
            }
        }
    }
