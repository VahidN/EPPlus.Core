    ...
    public class Sample16
    {
        ...
        public void RunSample16()
        {
            using (var package = new ExcelPackage())
            {
                ...
                using (var fs = new FileStream(Path.Combine("bin", "sample16.xlsx"), FileMode.Create))
                    package.SaveAs(fs);
            }

            using (var fs = new FileStream(Path.Combine("bin", "sample16.xlsx"), FileMode.Open, FileAccess.Read))
